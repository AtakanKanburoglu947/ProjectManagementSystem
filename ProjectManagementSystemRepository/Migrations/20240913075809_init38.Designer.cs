...
namespace ProjectManagementSystemRepository.Migrations
{
    ...
    [Migration("20240913075809_init38")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagementSystemCore.Models.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectManagementSystemCore.Models.Message", b =>
                {
                    b.HasOne("ProjectManagementSystemCore.Models.UserIdentity", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ProjectManagementSystemCore.Models.UserIdentity", "Sender")
                        .WithMany()
